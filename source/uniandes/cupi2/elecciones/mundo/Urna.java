...
public class Urna {
     ...
     * <b>post: </b> Se inicializaron los tres candidatos con los valores por
     * par�metro nombre, apellido, partido pol�tico y edad.
     */
    public Urna() {
    ...
    public int calcularTotalVotosInternet() {
        return candidato1.darVotosInfluenciaInternet() + candidato2.darVotosInfluenciaInternet()
     ...
     * 
     * @return La sumatoria de los votantes de g�nero masculino de los tres
     *         candidatos
     */
     ...
     * 
     * @return La raz�n de la sumatoria de los costos de campa�a de los candidatos y
     *         el n�mero total de candidatos.
     */
    ...
    /**
     * Devuelve el porcentaje de votos obtenidos por internet por el candidato 1
     * sobre el total de votos por internet.
     * 
    ...
    /**
     * Devuelve el porcentaje de votos obtenidos por internet por el candidato 2
     * sobre el total de votos por internet.
     * 
    ...
    /**
     * Devuelve el porcentaje de votos obtenidos por internet por el candidato 3
     * sobre el total de votos por internet.
     * 
    ...
    /**
     * Restaura la urna al estado inicial, todos los candidatos quedan sin votos y
     * costo de campa�a en 0
     */
